...
class _WelcomeScreenState extends State<WelcomeScreen>
  ...
  void _initializeAnimations() {
    ...
    _buttonScaleAnimation = Tween<double>(
      begin: 0.95, // Less dramatic than 0.8
      end: 1.0,
    ).animate(CurvedAnimation(
  ...
  void _onCreateAccountPressed() {
    ...
    NavigationUtils.navigateWithSlide(context, const CreateAccountScreen());
  ...
  void _onLoginPressed() {
    ...
    NavigationUtils.navigateWithSlide(context, const LoginScreen());
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildAnimationSection(
                            screenSize, isTablet, isSmallScreen, isLargeScreen),
  ...
  Widget _buildAnimationSection(
      Size screenSize, bool isTablet, bool isSmallScreen, bool isLargeScreen) {
    final animationSize =
        _getAnimationSize(screenSize, isTablet, isSmallScreen, isLargeScreen);
      ...
      child: Column(
        children: [
          ...
          _buildCreateAccountButton(
              buttonWidth, buttonHeight, isTablet, isSmallScreen),
  ...
  Widget _buildCreateAccountButton(
      double width, double height, bool isTablet, bool isSmallScreen) {
    return Container(
      width: width,
      height: height,
      decoration: BoxDecoration(
